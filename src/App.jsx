      ...
      <div>
        ...
        {phase === 1 && (
          <div>
            ...
            <GBtn onClick={() => setPhase(2)} color={C.blue} full>Next: Fill in Your Details →</GBtn>
          </div>
        )}
        ...
        {phase === 2 && (
          <div>
            ...
            {fw?.fields.map(f => (
              <FieldInput key={f.key} f={f} value={fields[f.key]||""} onChange={v => setFields(p=>({...p,[f.key]:v}))} />
            ))}
            <GBtn onClick={() => setPhase(3)} color={C.purple} full disabled={!hasContent}>
