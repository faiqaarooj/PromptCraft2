/**
 * Prompts routes — serves the read-only prompt library.
 *
 * GET  /api/prompts             – list all library prompts
 * GET  /api/prompts/:id         – get a single library prompt by id
 *
 * The library data mirrors the PROMPT_LIBRARY constant in the frontend so the
 * backend becomes the single source of truth once you wire up the API calls.
 */
